...
<div class="card shadow mb-4">
    <div class="card-header py-3">
      <h4 class="m-0 font-weight-bold text-primary"> Edit Event
	...
	<div class="card-body">
		<form action="<?= base_url('admin/updateevent') ?>" method="POST" enctype="multipart/form-data">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" name="judul" class="form-control" id="name" value="<?= $event["judul"] ?>">
				</div>
